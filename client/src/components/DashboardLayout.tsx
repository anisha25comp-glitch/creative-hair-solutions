...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  if (!user) return <div className="staff-login-shell"><div className="staff-login-card"><div className="staff-login-mark">TC</div><span className="admin-kicker">The Creative · Staff portal</span><h1>Staff login</h1><p>Sign in securely to manage salon operations, appointments, enquiries and billing.</p><Button onClick={() => startLogin()} size="lg" className="staff-login-button">Sign in as staff</Button><a className="staff-login-back" href="/">Return to salon website</a></div></div>;
