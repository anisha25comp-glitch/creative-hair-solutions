...
const products = [
  { name: "Absolut Repair Shampoo", brand: "L’Oréal Professionnel", category: "Hair care", price: 1250, tag: "Repair", image: "/products/shampoo.jpg", description: "Repair-focused cleansing for dry, damaged hair." },
  { name: "Vitamino Color Conditioner", brand: "L’Oréal Professionnel", category: "Hair care", price: 1350, tag: "Colour care", image: "/products/shampoo.jpg", description: "Colour care that keeps hair soft, glossy and vibrant." },
  { name: "Fibre Clinix Hair Mask", brand: "Schwarzkopf Professional", category: "Hair care", price: 1650, tag: "Best seller", image: "/products/hair-mask.jpg", description: "A deep weekly ritual for stronger-looking hair." },
  { name: "Professional Smoothening Serum", brand: "The Creative edit", category: "Hair care", price: 899, tag: "Finishing", image: "/products/serum.jpg", description: "A lightweight finishing serum for shine and frizz control." },
  { name: "Hair Spa Repair Kit", brand: "The Creative edit", category: "Hair care", price: 1499, tag: "Ritual", image: "/products/spa-mask.jpg", description: "A complete at-home care ritual between salon visits." },
  { name: "Hydrating Facial Care Kit", brand: "The Creative edit", category: "Skin care", price: 950, tag: "Skin care", image: "/products/spa-mask.jpg", description: "A gentle at-home reset for a calm, fresh-looking glow." },
];
...
export default function Store() {
  ...
  return <div className="store-page">
    ...
    <main>
      <section className="store-hero-page"><div><p className="store-kicker">THE CREATIVE EDIT</p><h1>Bring the<br /><em>ritual home.</em></h1><p className="store-hero-copy">Professional hair and beauty essentials chosen by our team to keep your salon finish looking fresh between visits.</p><a href="#products" className="store-gold-button">Shop the edit <ArrowRight size={16} /></a></div><div className="store-hero-image"><img src="/products/hair-mask.jpg" alt="Curated salon hair-care products" /></div></section>
